...
class Informes():
    ...
    def reportCli():
        try:
            ...
            Informes.header()
            var.report.drawString(100,730, var.configReport['tituloInforme'])
    ...
    def header():
        try:
            # logo =".\\recursos\logo_ies_teis.jpg"
            cif = "C1234578"
            nombre = "Ejemplo importación y exportación"
            direccion = "Avenida Galicia, 101 - 36216 Vigo (Pontevedra)"
            telefono  = "886 12 04 64"
