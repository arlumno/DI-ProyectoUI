...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMinimumSize(QtCore.QSize(888, 700))
        MainWindow.setMaximumSize(QtCore.QSize(888, 700))
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(97, 186, 160, 31))
        ...
        self.etDni.setGeometry(QtCore.QRect(96, 90, 113, 20))
        self.etDni.setText("")
        self.etDni.setObjectName("etDni")
        self.label_9 = QtWidgets.QLabel(self.tabClientes)
        self.label_9.setGeometry(QtCore.QRect(260, 90, 81, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.bSalir.setGeometry(QtCore.QRect(760, 590, 80, 31))
        self.bSalir.setObjectName("bSalir")
        self.label_5 = QtWidgets.QLabel(self.tabClientes)
        self.label_5.setGeometry(QtCore.QRect(31, 192, 47, 13))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_7.setGeometry(QtCore.QRect(29, 156, 61, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.line_2.setGeometry(QtCore.QRect(30, 267, 801, 30))
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.label_2 = QtWidgets.QLabel(self.tabClientes)
        self.label_2.setGeometry(QtCore.QRect(29, 123, 61, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_6.setGeometry(QtCore.QRect(270, 190, 111, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_3.setGeometry(QtCore.QRect(364, 120, 61, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.bCalendar.setGeometry(QtCore.QRect(437, 84, 31, 31))
        ...
        self.label_8.setGeometry(QtCore.QRect(364, 150, 61, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tablaDatos.setGeometry(QtCore.QRect(30, 330, 811, 251))
        ...
        self.bFiltrarClientes.setGeometry(QtCore.QRect(810, 290, 29, 31))
        ...
        self.etFiltro.setGeometry(QtCore.QRect(640, 300, 161, 20))
        self.etFiltro.setObjectName("etFiltro")
        self.bCargarClientes = QtWidgets.QPushButton(self.tabClientes)
        self.bCargarClientes.setGeometry(QtCore.QRect(30, 290, 31, 31))
        ...
        self.bGrabarCliente = QtWidgets.QPushButton(self.tabClientes)
        self.bGrabarCliente.setGeometry(QtCore.QRect(510, 230, 80, 31))
        self.bGrabarCliente.setStyleSheet("background-color: rgb(0, 190, 0);\n"
"color: white;\n"
"font-weight: bold")
        self.bGrabarCliente.setObjectName("bGrabarCliente")
        self.bModificarCliente = QtWidgets.QPushButton(self.tabClientes)
        self.bModificarCliente.setGeometry(QtCore.QRect(110, 290, 81, 31))
        ...
        self.bEliminarCliente.setGeometry(QtCore.QRect(30, 230, 81, 31))
...
"font-weight: bold")
        ...
        self.bLimpiarClientes.setGeometry(QtCore.QRect(70, 290, 31, 31))
        self.bLimpiarClientes.setToolTipDuration(1)
        self.bLimpiarClientes.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("clean.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.label_10.setGeometry(QtCore.QRect(470, 300, 171, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.bLimpiarCampos.setGeometry(QtCore.QRect(600, 230, 31, 30))
        ...
        self.label_11.setGeometry(QtCore.QRect(30, 582, 501, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.bEliminarClienteSeleccionado.setGeometry(QtCore.QRect(200, 290, 141, 31))
...
"font-weight: bold")
        ...
        self.bGuardarCambios.setGeometry(QtCore.QRect(120, 230, 110, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bGrabarCliente.setText(_translate("MainWindow", "Nuevo"))
